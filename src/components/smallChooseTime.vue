<template>
  <div
      class=" h-[250px] bg-slate-200 absolute top-[140px] left-[170px] overflow-hidden w-[150px] text-[12px] shadow-[0px_4px_12px_6px_rgba(34,60,80,0.2)] rounded-[5px] overflow-hidden">
